...
CN_BASE="internallb_webhook_admission_controller"
...
openssl req -new -key serverKey.pem -out server.csr -subj "/CN=internallb-webhook-admission-controller.default.svc" -config server.conf
